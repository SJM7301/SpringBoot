...
public class BookMarketController {
	...
	public String processAddBook(@RequestParam("bookId") String bookId, @RequestParam("name") String name,
			@RequestParam("unitPrice") String unitPrice, @RequestParam("author") String author,
			@RequestParam("publisher") String publisher, @RequestParam("releaseDate") String releaseDate,
			@RequestParam("description") String description, @RequestParam("category") String category,
			@RequestParam("unitsInStock") String unitsInStock, @RequestParam("condition") String condition,
	...
	public String processUpdateBook(@RequestParam("bookId") String bookId, @RequestParam("name") String name,
			@RequestParam("unitPrice") String unitPrice, @RequestParam("author") String author,
			@RequestParam("publisher") String publisher, @RequestParam("releaseDate") String releaseDate,
			@RequestParam("description") String description, @RequestParam("category") String category,
			@RequestParam("unitsInStock") String unitsInStock, @RequestParam("condition") String condition,
			@RequestParam(value = "bookImage", required = false) MultipartFile file, HttpServletRequest request)
			throws IOException {
