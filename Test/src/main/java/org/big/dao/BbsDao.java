...
public class BbsDao {
	...
	public ArrayList<BbsDto> getBoardList(int page, int limit, String items, String text) {
		...
		try {
			...
			System.out.println("getBoardList() 실행 : " + ex);
		} finally {
			try {
				if (rs != null)
					rs.close();
	...
	public String getLoginNameById(String id) {
		...
		try {
			...
			System.out.println("getBoardByNum() 실행 : " + ex);
		} finally {
			try {
				if (rs != null)
					rs.close();
	...
	public void insertBoard(BbsDto board) {
		...
		try {
			...
			System.out.println("insertBoard() 실행 : " + ex);
		} finally {
			try {
				if (pstmt != null)
					pstmt.close();
	...
	public void updateBoard(BbsDto board) {
		...
		try {
			...
			System.out.println("updateBoard() 실행 : " + ex);
		} finally {
			try {
				if (pstmt != null)
					pstmt.close();
	...
	public void deleteBoard(int num) {
		...
		try {
			...
			System.out.println("deleteBoard() 실행 : " + ex);
		} finally {
			try {
				if (pstmt != null)
					pstmt.close();
