...
<body>
	<div class="container py-4">
		<jsp:include page="/bookmarket/menu.do" /> <!-- 메뉴 JSP 포함 -->
		...
		<div class="row align-items-md-stretch">
			...
			<div class="col-md-6">
				...
				<p><form action="/bookmarket/addCart.do?id=<%=rs.getString("b_id") %>" name="addForm" method="post">
						<p><a href="#" class="btn btn-info" onclick="addToCart()">도서주문 &raquo;</a>
						<a href="/bookmarket/cart.do?id=<%=rs.getString("b_id") %>" class="btn btn-warning">장바구니 &raquo;</a>
		...
		<jsp:include page="/bookmarket/footer.do" /> <!-- 푸터 포함 -->
	</div>
</body>
</html>