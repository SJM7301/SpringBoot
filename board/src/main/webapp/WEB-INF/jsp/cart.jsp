        ...
        <div class="row align-items-md-stretch">
            <div class="row">
                ...
                <table width="100%">
                    <tr>
                        <!-- 장바구니 삭제하기 링크 -->
                        <td align="left"><a href="/bookmarket/deleteCart.do?cartId=<%=cartId %>" class="btn btn-danger">삭제하기</a></td>
                        <!-- 주문하기 링크 -->
                        <td align="right"><a href="/bookmarket/shippingInfo.do?cartId=<%=cartId %>" class="btn btn-success">주문하기</a></td>
                    </tr>
                </table>
            </div>
            ...
            <div style="padding-top: 50px">
                ...
                <!-- 쇼핑 계속하기 버튼 -->
                <a href="/bookmarket/books.do" class="btn btn-secondary">&laquo; 쇼핑 계속하기</a>
            </div>
        </div>
